...
| 레벨 | 기여하는 커버리지 |
|---|---|
| Level 1: Happy Case (40%) | 라인 커버리지 기본 확보, 메서드 커버리지 100% |
| Level 2: Edge Case (30%) | 분기 커버리지 향상 (null/경계값 분기) |
| Level 3: Exception (20%) | 예외 경로 라인/분기 커버리지 |
| Level 4: Mutation (10%) | 뮤테이션 커버리지 (조건 변이 검출) |
