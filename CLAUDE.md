...
- Java 1.8 (source/target) + Spring Boot 2.7.17 + Gradle 7.6.4 (Kotlin DSL)
- Spring Security + JWT (jjwt 0.11.5)
- MyBatis 2.3.2 + H2 (인메모리 DB)
- springdoc-openapi-ui 1.8.0 (Swagger UI)
- 테스트: JUnit 5 + Mockito + AssertJ + Spring Security Test
- 품질: JaCoCo 0.8.11 (라인 80%, 분기 70%) + PIT 1.7.4 (mutation 65%)
...
- Gradle 6.8.3(TRD 명시)은 JDK 17과 비호환으로 7.6.4로 조정
